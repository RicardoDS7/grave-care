        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-gray-50 rounded-lg p-6">
              ...
              <div className="space-y-3 text-gray-600">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <span>Hours may vary — please confirm with the municipality</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="relative">
            <div className="relative h-96 lg:h-[500px] rounded-2xl overflow-hidden shadow-2xl bg-gray-100">
              {/* Google Map Embed */}
              <iframe
                src="https://www.google.com/maps?q=Boksburg%20Sub%20Regional%20Cemetery&output=embed"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen
                ...
                title="Boksburg Sub Regional Cemetery Location Map"
              ...
              <div className="absolute top-4 left-4 bg-white/95 backdrop-blur-sm rounded-lg p-4 shadow-lg max-w-xs">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <h4 className="font-semibold text-gray-900 text-sm">Boksburg Sub Regional Cemetery</h4>
                </div>

                <p className="text-xs text-gray-600 mb-2">Boksburg, Gauteng</p>

                <a
                  href="https://www.google.com/maps/dir/?api=1&destination=Boksburg%20Sub%20Regional%20Cemetery"
                  target="_blank"
