...
export { default as AboutWesparkCemetery } from './AboutWestparkCemetery'
...
export type { default as AboutWesparkCemeteryProps } from './AboutWestparkCemetery'
export type { default as ContactFormProps } from '../../components/ContactForm'
export type { default as FAQSectionProps } from './FAQSection'
